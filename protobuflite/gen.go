...
func writeEncodeFunction(out io.Writer, message proto_parser.Message) {
...
func writeDecodeFunction(out io.Writer, message proto_parser.Message) {
...
func genTypes(out io.Writer, types []proto_parser.Message) {
	...
	for _, message := range types {
		writeEncodeFunction(out, message)
		writeDecodeFunction(out, message)
	}
}
